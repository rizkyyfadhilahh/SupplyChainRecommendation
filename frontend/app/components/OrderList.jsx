        ...
        {orders.map((order, i) => (
          ...
          >
            ...
            <div className="flex items-center gap-5 sm:gap-8 flex-1 pl-2">
              ...
              <div className="grid grid-cols-2 md:grid-cols-6 gap-x-6 gap-y-2 w-full items-center">
                ...
                <div className="flex flex-col">
                  <span className="text-[10px] uppercase font-bold tracking-wider text-slate-400 mb-0.5">Metric</span>
                  {order.recommendation_metric === "LOWEST_PCF" ? (
                    <span className="w-fit rounded-md border border-green-100 bg-green-50 px-2 py-0.5 text-[10px] font-bold text-green-700">
                      🌱 Low PCF
                    </span>
                  ) : (
                    <span className="w-fit rounded-md border border-blue-100 bg-blue-50 px-2 py-0.5 text-[10px] font-bold text-blue-700">
                      📦 Volume
                    </span>
                  )}
                </div>
